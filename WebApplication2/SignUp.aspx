...
<head runat="server">
    ...
    <title>Ticket Issue Tracker &amp; Register</title>
 ...
 <script type="text/javascript">
     ...
     function validatePassword(Password) {
         ...
         var passwl = /[a-z]/;
         var passwn = /[0-9]/;
         if (!passwl.test(Password) || !passw.test(Password) || !passwn.test(Password) || Password.length < 8) {
             alert("Password must be a combination of upper case, lower case, number, and at least 8 characters long. ");
             return false;
         }
         return true;
     }
     function GetMaster1Details() {
         ...
         var get_val = div.options(div.selectedIndex).value;
         alert("Please choose your division" + get_val);
     }
     ...
     function validateS() 
     {
         ...
         var passv = validatePassword(pass);
         if (pass == "" || cpass == "")
         {
               ...
               <div class="container">
                   ...
                   <div class="row">
                         <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h1><strong>Tracking Your Ticket </strong> Login &amp; Registration Form</h1>
                            
                            <div class="description">
                            	<p>
	                            	This is a free <strong>"Login and Registration form"</strong> for Tracking Your Booing Ticket. 
                            	</p>                            
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- sign up form start honay laga hai :)-->
                            ...
                            <div class="form-group">
                                <asp:DropDownList ID="Division" runat="server" 
                                    Width="228px" Height="39px" onchange="GetMaster1Details()">
